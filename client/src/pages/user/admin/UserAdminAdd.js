...
import { addOne__USER } from '../../../reduxStore/actions/user/users';
...
const UserAdminAdd = () => {
  ...
  useEffect(() => {
    dispatch(setNameOfPage('Добавить клиента'));
  }, [dispatch]);

  const onSubmit = () => {
    dispatch(addOne__USER(name, email, role, password, history));
...
UserAdminAdd.propTypes = {
  /////Actions//////
  setNameOfPage: PropTypes.func,
  addOne__USER: PropTypes.func,
