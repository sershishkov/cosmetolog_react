...
import { addOne__PROCEDURE } from '../../../reduxStore/actions/admin/procedure';
...
const ProcedureAdd = () => {
  ...
  useEffect(() => {
    dispatch(setNameOfPage('Добавить процедуру'));
  ...
  return (
    <Grid container className={classes.root} direction='column'>
      ...
      <Grid item className={`${classes.item} ${classes.wrapSelect}`}>
        <InputLabel id='drugs-label'>Лекарства</InputLabel>
        <Select
          labelId='drugs-label'
          id='drugs'
          name='drugs'
...
ProcedureAdd.propTypes = {
  /////Actions//////
  setNameOfPage: PropTypes.func,
  addOne__PROCEDURE: PropTypes.func,
